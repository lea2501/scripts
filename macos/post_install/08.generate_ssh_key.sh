...
echo "Generating ssh key in $HOME/.ssh/id_ed25519.pub file..."
cat /dev/zero | ssh-keygen -q -t ed25519 -N ""
echo "Generating ssh key in $HOME/.ssh/id_ed25519.pub file... DONE"
...
echo "  2) Paste the key copied from ~/.ssh/id_ed25519.pub and press 'Add key' button."
echo ""
