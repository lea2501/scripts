...
if [[ $ENGINE == "chocolate" ]]; then
    if [[ "$IWAD" == *"doom"* || "$IWAD" == "tnt" || "$IWAD" == "plutonia" ]]; then
        commandline="chocolate-doom -fullscreen -config $GAME_DIR/config/chocolate/config.ini -iwad $IWADS_DIR/$IWAD.wad -merge $pwadfile $MODS -savedir $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
    elif [[ "$IWAD" == "heretic" ]]; then
        commandline="chocolate-heretic -fullscreen -config $GAME_DIR/config/chocolate/config_heretic.ini -iwad $IWADS_DIR/$IWAD.wad -merge $pwadfile $MODS -savedir $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
    elif [[ "$IWAD" == "hexen" ]]; then
        commandline="chocolate-hexen -fullscreen -config $GAME_DIR/config/chocolate/config_hexen.ini -iwad $IWADS_DIR/$IWAD.wad -merge $pwadfile $MODS -savedir $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
    fi
elif [[ $ENGINE == "crispy" ]]; then
    if [[ "$IWAD" == *"doom"* || "$IWAD" == "tnt" || "$IWAD" == "plutonia" ]]; then
        commandline="crispy-doom -fullscreen -config $GAME_DIR/config/crispy/config_nolimit.ini -iwad $IWADS_DIR/$IWAD.wad -file $pwadfile $MODS -savedir $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
    elif [[ "$IWAD" == "heretic" ]]; then
        commandline="crispy-heretic -fullscreen -config $GAME_DIR/config/crispy/config_nolimit_heretic.ini -iwad $IWADS_DIR/$IWAD.wad -file $pwadfile $MODS -savedir $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
    elif [[ "$IWAD" == "hexen" ]]; then
        #commandline="crispy-hexen -fullscreen -config $GAME_DIR/config/crispy/config_nolimit_hexen.ini -iwad $IWADS_DIR/$IWAD.wad -file $pwadfile $MODS -savedir $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
        echo "ERROR: crispy engine is not available with hexen game!"
        exit 1
    fi
elif [[ $ENGINE == "prboom-plus" ]]; then
    #commandline="prboom-plus -config $GAME_DIR/config/prboom-plus/prboom-plus_vanilla.cfg -vidmode gl -complevel 17 -width 1920 -height 1080 -fullscreen -geom 640x360f -aspect 16:9 -iwad $IWADS_DIR/$IWAD.wad -file $pwadfile $MODS -save $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
    commandline="prboom-plus -config $GAME_DIR/config/prboom-plus/prboom-plus_vanilla.cfg -vidmode gl -complevel 17 -width 1920 -height 1080 -fullscreen -aspect 16:9 -iwad $IWADS_DIR/$IWAD.wad -file $pwadfile $MODS -save $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
elif [[ $ENGINE == "gzdoom" ]]; then
    commandline="gzdoom -config $GAME_DIR/config/zdoom/config_zdoom.ini -width 1920 -height 1080 -fullscreen -iwad $IWADS_DIR/$IWAD.wad -file $pwadfile $MODS -savedir $GAME_DIR/savegames/$IWAD/ -skill $SKILL -warp $pwadmap"
fi
