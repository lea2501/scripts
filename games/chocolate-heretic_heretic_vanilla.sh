...
game=heretic
heretic_bin=$(game_bin "$HOME/src/chocolate-doom/src/chocolate-heretic" chocolate-heretic) || exit 1
...
"$heretic_bin" -config "$game_dir"/config/chocolate/config_heretic.ini \
