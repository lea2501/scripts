...
cd || return
# system
$su pacman -S pacman-contrib base-devel tmux vi vim nano udisks2 brightnessctl dos2unix exfatprogs picom firejail
...
# pulseaudio
$su pacman -S pulseaudio pavucontrol pulseaudio-alsa
