...
#apt-get -y --fix-missing install -t chimaera-backports linux-image-amd64 firmware-linux firmware-linux-nonfree firmware-amd-graphics libgl1-mesa-dri libglx-mesa0 mesa-vulkan-drivers xserver-xorg-video-all
